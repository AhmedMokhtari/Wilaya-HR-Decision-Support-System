...
from GestionPersonnel.models import Service,Caidat,Pashalik,Annexe

# Create your models here.

class Stage2(models.Model):
    idstage = models.AutoField(db_column='IdStage', primary_key=True)
    nomstagiairear = models.CharField(db_column='NomStagiaireAr', max_length=20, db_collation='French_CI_AS',
                                      blank=True, null=True)
    prenomstagiairear = models.CharField(db_column='PrenomStagiaireAr', max_length=20, db_collation='French_CI_AS',
                                         blank=True, null=True)
    nomstagiairefr = models.CharField(db_column='NomStagiaireFr', max_length=20, db_collation='French_CI_AS',
                                      blank=True, null=True)
    prenomstagiairefr = models.CharField(db_column='PrenomStagiaireFr', max_length=20, db_collation='French_CI_AS',
                                         blank=True, null=True)
    ...
    organisme = models.CharField(db_column='Organisme', max_length=50, db_collation='French_CI_AS', blank=True,
                                 null=True)
...
class ServiceStage(models.Model):
    ...
    idservice_field = models.ForeignKey(Service, models.DO_NOTHING, db_column='IdService#', blank=True, null=True)
    idstage_field = models.ForeignKey(Stage2, models.DO_NOTHING, db_column='IdStage#', blank=True, null=True)
    class Meta:
        managed = False
