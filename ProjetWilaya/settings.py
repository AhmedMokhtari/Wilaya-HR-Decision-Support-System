"""
Django settings for ProjetWilaya project.
...
SECRET_KEY = 'django-insecure-*%=hhnw3euiydi2$tdppqhkd)2ko8lotsuvrpmh)b6%2a*rsk&'
...
INSTALLED_APPS = [
    ...
    'GestionStagiaire.apps.GestionstagiaireConfig',
...
ROOT_URLCONF = 'ProjetWilaya.urls'
...
WSGI_APPLICATION = 'ProjetWilaya.wsgi.application'
